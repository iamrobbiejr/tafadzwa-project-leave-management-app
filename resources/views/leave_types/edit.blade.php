        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="isolate bg-white px-6 py-12 sm:py-24 lg:px-8">
                    ...
                    <form action="{{ route('leave-types.update', $leaveType) }}" method="POST" class="mx-auto mt-6 max-w-xl sm:mt-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2.5">
                                    <input type="text" name="name" id="name" value="{{ $leaveType->name }}" readonly
                                           autocomplete="name" class="block w-full rounded-md border-0 px-3.5 py-2
                                           text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400
                                           bg-gray-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="relative mt-2.5">
                                    <input type="number" min="24" value="{{ $leaveType->days_per_year }}" name="days_per_year" id="days_per_year" autocomplete="days" class="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
