                    ...
                    <form action="{{ route('leave-requests.store') }}" method="POST" class="mx-auto mt-6 max-w-xl sm:mt-8">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2.5">
                                    <select id="leave_type_id" name="leave_type_id" required class="block h-full w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                       @foreach($balances as $balance)
                                            <option value="{{ $balance->leave_type_id }}">
                                                {{ $balance->leaveType($balance->leave_type_id)->name }} - {{ $balance->remaining_days }} remaining days
                                            </option>
                                       @endforeach
                                    </select>
                            ...
                            <div >
                                ...
                                <div class="mt-2.5">
                                    <input type="date" required name="start_date" id="start_date" autocomplete="start_date" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            ...
                            <div >
                                ...
                                <div class="mt-2.5">
                                    <input type="date" disabled name="end_date" id="end_date" autocomplete="end_date" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2.5">
                                    <input type="number" readonly name="no_of_days" id="no_of_days" class="block w-full
