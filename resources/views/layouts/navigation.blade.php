...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="block h-9 w-auto" src="{{ asset('logo.webp') }}" alt="Logo">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->isAdmin())
                        ...
                        <x-nav-link :href="route('leave-requests.index')"
                                    :active="request()->routeIs('leave-requests.index')">
                            {{ __('Leave Requests') }}
                        </x-nav-link>
                        <x-nav-link :href="route('leave-balance.index')"
                                    :active="request()->routeIs('leave-balance.index')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('leave-balance.index')"
                                   :active="request()->routeIs('leave-balance.index')">
                {{ __('Employee Leave Balances') }}
            </x-responsive-nav-link>
            @endif
